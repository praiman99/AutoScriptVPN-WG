...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard already installed, please type add-wg for add client."
	exit 1
fi

echo -e "${Info} AutoScriptVPN-Wireguard Installer by PR Aiman"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://github.com/praiman99/AutoScriptVPN-WG/raw/beginner/Files/WG/add-wg.sh"
wget -O del-wg "https://github.com/praiman99/AutoScriptVPN-WG/raw/beginner/Files/WG/del-wg.sh"
wget -O renew-wg "https://github.com/praiman99/AutoScriptVPN-WG/raw/beginner/Files/WG/renew-wg.sh"
wget -O menu "https://github.com/praiman99/AutoScriptVPN-WG/raw/beginner/Files/WG/menu.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x renew-wg
chmod +x menu
